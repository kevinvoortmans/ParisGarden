...
Component.options.__file = "resources/js/components/SettingsTool.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6e679ec6", Component.options)
  } else {
    hotAPI.reload("data-v-6e679ec6", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__partials_Toggle__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__partials_Text__ = __webpack_require__(18);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        Nova.request().get('/nova-vendor/settings-tool').then(function (response) {
    ...
    methods: {
        ...
        saveAndReload: function saveAndReload(groupName) {
            ...
            Nova.request().post('/nova-vendor/settings-tool', { settings: settingsToUpdate }).then(function (response) {
...
var update = __webpack_require__(11)("15d1babd", content, false, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Label__ = __webpack_require__(1);
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("setting-label", [_vm._v(_vm._s(_vm.__(_vm.name)))]),
      _vm._v(" "),
  ...
  return _c(
    ...
    [
      _vm.loading
        ...
        : _vm._e(),
      _vm._v(" "),
      _vm._l(_vm.settingConfig, function(group) {
        return _c(
          "div",
          [
            ...
            _c(
              "card",
              { staticClass: "relative overflow-hidden mb-8" },
              [
                _vm._l(group.settings, function(setting) {
                  return _c(
                    "div",
                    [
                      setting.type == "toggle"
                        ? _c("toggle-setting", {
                            attrs: {
                              ...
                              setting: {
                                key: setting.key,
                                value: _vm.settings[setting.key]
                              }
                            },
                ...
                _c(
                  ...
                  [
                    _c(
                      ...
                      {
                        staticClass: "ml-auto",
                        attrs: { processing: _vm.saving == group.name },
                        nativeOn: {
                          click: function($event) {
                            _vm.saveAndReload(group.name)
                          }
                        }
                      },
                      [_vm._v("\n                    Save\n                ")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6e679ec6", module.exports)
  }
}
